...
<div class="goalTxt">목표 장바구니</div>
  ...
  var addgoalbtn = document.querySelector(".goalAdd");
  var goalingg = document.querySelector(".goalingg");

  addGoalEvent = () => {
    var newGoalName = document.querySelector(".goalTxtInput").value;
